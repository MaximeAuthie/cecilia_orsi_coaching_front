    ...
    <footer>
        <nav class="footer_nav">
            <ul class="footer_nav_list">
                ...
                <li class="footer_nav_list_item">
                    <nuxt-link to="/legalInformations"></nuxt-link>
                </li>
                <li class="footer_nav_list_item">
                    <nuxt-link class="footer_nav_list_item_instagram" to="https://www.instagram.com/cecilia_orsi_coaching/" target="_blank" rel="external">
...
.footer_nav_list_item svg {
    stroke: #FFFFFF;
    width: 5vh;
    height: 5vh;
    margin-right: 2vw;
}
.footer_nav_list_item_instagram svg {
    stroke: #FFFFFF;
    width: 10vh;
    height: 10vh;
    margin: 0;
}
.footer_nav_list_item_instagram:visited {
    color: #FFFFFF;
}
